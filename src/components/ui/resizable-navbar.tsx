    ...
    <motion.div
      animate={{
        ...
        boxShadow: visible
          ...
          : "0 0 12px rgba(34, 42, 53, 0.03), 0 1px 1px rgba(0, 0, 0, 0.02), 0 0 0 1px rgba(34, 42, 53, 0.02), 0 0 2px rgba(34, 42, 53, 0.04), 0 8px 34px rgba(47, 48, 55, 0.02), 0 1px 0 rgba(255, 255, 255, 0.05) inset",
      ...
      className={cn(
        "relative z-[60] mx-auto hidden w-full max-w-[95rem] flex-row items-center justify-between self-start rounded-full px-4 py-2 lg:flex",
        visible ? "bg-white/80 dark:bg-neutral-950/80" : "bg-white/20 dark:bg-neutral-950/30",
        className,
      )}
    >
      {children}
...
export const MobileNav = ({ children, className, visible }: MobileNavProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-50 mx-auto flex w-full max-w-[calc(100vw-2rem)] flex-col items-center justify-between px-0 py-2 lg:hidden overflow-hidden",
        visible ? "bg-white/80 dark:bg-neutral-950/80" : "bg-white/20 dark:bg-neutral-950/30",
        className,
      )}
    >
...
export const MobileNavMenu = ({
  ...
  return (
    ...
    >
      <div className="flex w-full flex-col items-start justify-start gap-4 px-4 py-6">
        {children}
      </div>
    </motion.div>
  );
...
export const MobileNavOverlay = ({ isOpen, onClick }: MobileNavOverlayProps) => {
  return (
    <AnimatePresence>
      {isOpen && (
        <motion.div
